...
local Config = {
    ...
    ServiceId       = 24640, -- Your PlatoBoost Service ID
    ...
    -- [6] GUI Management
    OldGuiName      = "ChickenHub", -- Name of the old GUI to destroy if it's already open
    MainGuiName     = "ChickenHub", -- Name of the main script's GUI to check if it's already executing

    -- [7] Hub Information & UI Text
    HubName         = "ChickenHUb", -- The main title shown at the top of the GUI
    HubDescription  = "slxzy_101 on Discord" -- The text shown below the title
}
